    ...
    <div className='flex min-h-screen'>
      <div className='flex flex-col items-center border-r shadow-md'>
        <div className='flex flex-col flex-grow w-[250px]'>
          <div onClick={handleHome} className='flex flex-col justify-center items-center h-20 bg-blue-900 text-white hover:cursor-pointer'>
        ...
        <button onClick={() => signOut()} className='flex justify-center items-center px-4 py-2 mb-10 border-none text-xl font-semibold hover:text-red-700'>
